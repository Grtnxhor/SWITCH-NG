...
<?php include("include/sidebar2.php"); ?>
 ...
 $sql="SELECT * FROM ichange_product WHERE Sold='In Stock' AND `Product_Category` = '$pcat'";
 ...
 <img src= "upload/product/'.$row['prodpix'].'" alt="product picture">';
                            ...
                            <div class="product-description d-flex align-items-center justify-content-between">
                                ...
                                <div class="product-meta-data">
                                   ...
                                   <?php
                    echo '
                    <a href="prodetail2.php?id='.$row['Product_ID'].'">';
                    ?>
                                ...
                                <div class="ratings-cart text-right">
                                    ...
                                    <div class="cart">
                                        <a href="cart2.php" data-toggle="tooltip" data-placement="left" title="Add to Cart"><img src="img/core-img/cart.png" alt=""></a>
                                    </div>
                                </div>
                            </div>
                        </div>
