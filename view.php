      ...
      <div class="card card-solid">
        <div class="card-body">
          <div class="row">
            ...
            <div class="col-12 col-sm-6">
              <h3 class="my-3"><b>Prodcut Name:</b> <?php echo $row['Product_Name']; ?></h3>
              <p><b>Prodcut Details:</b> <?php echo $row['Product_Fault']; ?></p>
...
<form method="post">
              <div class="bg-gray py-2 px-3 mt-4">
                ...
                <input style="width: 100%;" type="number" name="serv" class="py-2 px-3 mt-4" required>
...
<br/>
              ...
              <div class="mt-4 product-share">
                  <div class="btn btn-default btn-lg btn-flat">
                    <?php 
                    $msg = "Hello ".$row['Username']."! Your Product with Product_ID.:".$row['Product_ID']." and <br/> Product_Name.:".$row['Product_Name']." has been approved sucessfully <br/> You shall be notified when your product is sold!<br/><br/><i>iChange Team</i>";
                    $_SESSION['m'] = $msg;
                    $_SESSION['v'] = $row['Username'];
                    echo '
                  <a href="send.php?id='.$row['Username'].'"><i class="fas fa-phone fa-lg mr-2"></i> 
                 Contact Seller</a>';
                 ?>
                </div>
              </div>
...
<!-- ./wrapper -->
 ...
 while($row= mysqli_fetch_array($result_set))
 {
  ?>             
              <?php
              echo '
              <a href="testg.php?id='.$row['Product_ID'].'"><button type="submit" class="btn btn-primary">Continue</button></a>';
              ?>
            </div>
            <?php
          }
